...
// Mock data to show if no content-manifest.json is found (for demo purposes)
...
/**
 * Fetches the content-manifest.json file from the resources folder.
 */
export const fetchManifest = async (): Promise<Manifest> => {
  try {
    ...
    console.warn('Could not load content-manifest.json, using mock data.', error);
