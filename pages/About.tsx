    ...
    <div className="max-w-2xl mx-auto space-y-8 animate-fade-in pb-12">
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 text-center relative overflow-hidden">
        ...
        <p className="text-slate-600 leading-relaxed mb-8 max-w-lg mx-auto">
          Hi there! Welcome to my digital travel diary. I built this space to document my adventures, share itineraries,
          and keep track of the beautiful places I've visited. I love photography, hiking, and finding the best coffee
          in every city.
        </p>
